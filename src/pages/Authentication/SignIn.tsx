...
const SignIn: React.FC = () => {
  ...
  const { login, error, isAuthenticated } = useLogin();
  ...
  return (
    <>
      <div className=" bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-screen">
              ...
              <form onSubmit={handleSubmit}>
                ...
                {message?.type === 'error' && (
                  <p className="text-red-500  text-3xl text-center">
                    Surgio un error, vuelva a intentarlo
                  </p>
                )}{' '}
